...
entropy2Table <- read.table(file=paste(inputFolder, "/ComparisonEntropySpec2", sep=""), sep="\t", header=TRUE)
entropy4Table <- read.table(file=paste(inputFolder, "/ComparisonEntropySpec3", sep=""), sep="\t", header=TRUE)
