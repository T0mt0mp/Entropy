...
plot(dataTable$Entropy~dataTable$Threads, type="n", xlim=c(xRange[1], xRange[2] + 1), ylim=c(1, 1000000), ann=FALSE, axes=FALSE)
...
title(main="Processing entities in parallel", xlab="Number of threads", ylab="Time per iteration [ns]")
