...
plot(dataTable$Anax~dataTable$Entities, type="n", xlim=c(xRange[1], xRange[2]), ylim=c(1000000, 65000000), ann=FALSE, axes=FALSE)
axis(1, at=seq(from=xRange[1], to=xRange[2], by=1), lwd=2)
#yTicks <- seq()
#axis(2, lwd=2)
yAt <- seq(from=0, to=65000000, by=10000000)
